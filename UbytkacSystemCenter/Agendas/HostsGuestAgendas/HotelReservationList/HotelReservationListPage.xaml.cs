    ...
    public partial class HotelReservationListPage : UserControl {
        ...
        public async Task<bool> LoadDataList() {
            ...
            try {
                ...
                hotelReservationList = await CommunicationManager.GetApiRequest<List<HotelReservationList>>(ApiUrls.HotelReservationList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token);
