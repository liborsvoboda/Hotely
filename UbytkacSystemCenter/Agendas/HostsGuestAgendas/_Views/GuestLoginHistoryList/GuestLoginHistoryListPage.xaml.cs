        ...
        public async Task<bool> LoadDataList() {
            ...
            try {
                if (MainWindow.serviceRunning) {
                    DgListView.ItemsSource = await CommunicationManager.GetApiRequest<List<GuestLoginHistoryList>>(ApiUrls.GuestLoginHistoryList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token);
                }
