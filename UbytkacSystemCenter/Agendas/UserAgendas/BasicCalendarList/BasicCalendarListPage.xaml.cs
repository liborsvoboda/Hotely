...
namespace EasyITSystemCenter.Pages {
    ...
    public partial class BasicCalendarListPage : UserControl {
        ...
        public async Task<bool> LoadDataList() {
            ...
            try {
                Data = await CommunicationManager.GetApiRequest<List<GlobalClasses.BasicCalendarList>>(ApiUrls.BasicCalendarList, App.UserData.Authentification.Id.ToString(), App.UserData.Authentification.Token);
        ...
        private async void Calendar_DayChanged(object sender, DayChangedEventArgs e) {
            ...
            DBResultMessage dBResult = await CommunicationManager.PostApiRequest(ApiUrls.BasicCalendarList, httpContent, null, App.UserData.Authentification.Token);
        }
