...
namespace EasyITSystemCenter.Pages {
    ...
    public partial class SystemParameterListPage : UserControl {
        ...
        public async Task<bool> LoadDataList() {
            ...
            try {
                parameterList = await CommunicationManager.GetApiRequest<List<SystemParameterList>>(ApiUrls.SystemParameterList, App.UserData.Authentification.Id.ToString(), App.UserData.Authentification.Token);
        ...
        public async void DeleteRecord() {
            ...
            if (result == MessageDialogResult.Affirmative) {
                DBResultMessage dBResult = await CommunicationManager.DeleteApiRequest(ApiUrls.SystemParameterList, selectedRecord.Id.ToString(), App.UserData.Authentification.Token);
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e) {
            try {
                ...
                if (selectedRecord.Id == 0) {
                    dBResult = await CommunicationManager.PutApiRequest(ApiUrls.SystemParameterList, httpContent, null, App.UserData.Authentification.Token);
                }
                else { dBResult = await CommunicationManager.PostApiRequest(ApiUrls.SystemParameterList, httpContent, null, App.UserData.Authentification.Token); }
