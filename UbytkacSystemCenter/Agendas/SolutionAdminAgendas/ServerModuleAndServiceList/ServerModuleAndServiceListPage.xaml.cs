...
namespace EasyITSystemCenter.Pages {
    ...
    public partial class ServerModuleAndServiceListPage : UserControl {
        ...
        public async Task<bool> LoadDataList() {
            ...
            try {
                solutionMixedEnumList = await CommunicationManager.GetApiRequest<List<SolutionMixedEnumList>>(ApiUrls.SolutionMixedEnumList, "ByGroup/ModulePageTypes", App.UserData.Authentification.Token);
                solutionMixedEnumListLayoutTypes = await CommunicationManager.GetApiRequest<List<SolutionMixedEnumList>>(ApiUrls.SolutionMixedEnumList, "ByGroup/WebLayoutTypes", App.UserData.Authentification.Token);
