    ...
    public partial class BusinessIncomingInvoiceListPage : UserControl {
        ...
        public async Task<bool> LoadDataList() {
            ...
            try {
                ...
                DocumentAdviceList = await CommApi.GetApiRequest<SystemDocumentAdviceList>(ApiUrls.SystemDocumentAdviceList, "incomingInvoice/" + defaultAddress.Id, App.UserData.Authentification.Token);
                ...
                IncomingInvoiceList = await CommApi.GetApiRequest<List<BusinessIncomingInvoiceList>>(ApiUrls.BusinessIncomingInvoiceList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token);
        ...
        public async void DeleteRecord() {
            ...
            if (result == MessageDialogResult.Affirmative) {
                DBResultMessage dBResult = await CommApi.DeleteApiRequest(ApiUrls.BusinessIncomingInvoiceList, selectedRecord.Id.ToString(), App.UserData.Authentification.Token);
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e) {
            try {
                ...
                if (selectedRecord.Id == 0) {
                    dBResult = await CommApi.PutApiRequest(ApiUrls.BusinessIncomingInvoiceList, httpContent, null, App.UserData.Authentification.Token);
                }
                else { dBResult = await CommApi.PostApiRequest(ApiUrls.BusinessIncomingInvoiceList, httpContent, null, App.UserData.Authentification.Token); }
                ...
                if (dBResult.RecordCount > 0) {
                    ...
                    dBResult = await CommApi.DeleteApiRequest(ApiUrls.BusinessIncomingInvoiceSupportList, dBResult.Status, App.UserData.Authentification.Token);
                    ...
                    dBResult = await CommApi.PutApiRequest(ApiUrls.BusinessIncomingInvoiceSupportList, httpContent, null, App.UserData.Authentification.Token);
        ...
        private async void SetRecord(bool? showForm = null, bool copy = false) {
            ...
            if (showForm != null && showForm == true) {
                ...
                DocumentItemList = await CommApi.GetApiRequest<List<DocumentItemList>>(ApiUrls.BusinessIncomingInvoiceSupportList, originalDocumentNumber, App.UserData.Authentification.Token);
