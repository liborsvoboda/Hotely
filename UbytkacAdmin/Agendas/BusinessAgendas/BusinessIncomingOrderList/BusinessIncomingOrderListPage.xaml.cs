    ...
    public partial class BusinessIncomingOrderListPage : UserControl {
        ...
        public async Task<bool> LoadDataList() {
            ...
            try {
                ...
                DocumentAdviceList = await CommApi.GetApiRequest<SystemDocumentAdviceList>(ApiUrls.SystemDocumentAdviceList, "incomingOrder/" + defaultAddress.Id, App.UserData.Authentification.Token);
                ...
                IncomingOrderList = await CommApi.GetApiRequest<List<BusinessIncomingOrderList>>(ApiUrls.BusinessIncomingOrderList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token);
        ...
        public async void DeleteRecord() {
            ...
            if (result == MessageDialogResult.Affirmative) {
                DBResultMessage dBResult = await CommApi.DeleteApiRequest(ApiUrls.BusinessIncomingOrderList, selectedRecord.Id.ToString(), App.UserData.Authentification.Token);
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e) {
            try {
                ...
                if (selectedRecord.Id == 0) {
                    dBResult = await CommApi.PutApiRequest(ApiUrls.BusinessIncomingOrderList, httpContent, null, App.UserData.Authentification.Token);
                }
                else { dBResult = await CommApi.PostApiRequest(ApiUrls.BusinessIncomingOrderList, httpContent, null, App.UserData.Authentification.Token); }
                ...
                if (dBResult.RecordCount > 0) {
                    ...
                    dBResult = await CommApi.DeleteApiRequest(ApiUrls.BusinessIncomingOrderSupportList, dBResult.Status, App.UserData.Authentification.Token);
                    ...
                    dBResult = await CommApi.PutApiRequest(ApiUrls.BusinessIncomingOrderSupportList, httpContent, null, App.UserData.Authentification.Token);
        ...
        private async void SetRecord(bool? showForm = null, bool copy = false) {
            try {
                ...
                if (showForm != null && showForm == true) {
                    ...
                    else { DocumentItemList = await CommApi.GetApiRequest<List<DocumentItemList>>(ApiUrls.BusinessIncomingOrderSupportList, originalDocumentNumber, App.UserData.Authentification.Token); }
        ...
        private async void SetSubListsNonActiveOnNewItem(bool newItem) {
            if (newItem) {
                AddressList = (await CommApi.GetApiRequest<List<BusinessAddressList>>(ApiUrls.BusinessAddressList, null, App.UserData.Authentification.Token)).Where(a => a.Active && (a.AddressType == "all" || a.AddressType == "customer")).ToList();
                ...
                AddressList = (await CommApi.GetApiRequest<List<BusinessAddressList>>(ApiUrls.BusinessAddressList, null, App.UserData.Authentification.Token)).Where(a => a.AddressType == "all" || a.AddressType == "customer").ToList();
        ...
        private async void ImportOffer() {
            try {
                ...
                IncomingOrderList = await CommApi.GetApiRequest<List<BusinessIncomingOrderList>>(ApiUrls.BusinessIncomingOrderList, null, App.UserData.Authentification.Token);
                IncomingOrderList.ForEach(record => {
