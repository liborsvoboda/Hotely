        ...
        public async Task<bool> LoadDataList() {
            ...
            try {
                if (MainWindow.serviceRunning) {
                    DgListView.ItemsSource = await CommApi.GetApiRequest<List<SystemLoginHistoryList>>(ApiUrls.SystemLoginHistoryList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token);
                }
