...
namespace EasyITSystemCenter.Pages {
    ...
    public partial class DocumentationGroupListPage : UserControl {

        public static DataViewSupport dataViewSupport = new DataViewSupport();
        public static DocumentationGroupList selectedRecord = new DocumentationGroupList();
        ...
        public void Filter(string filter) {
            try
            {
                ...
                {
                    DocumentationGroupList user = e as DocumentationGroupList;
        ...
        public void NewRecord() {
            selectedRecord = new DocumentationGroupList();
        ...
        public void EditRecord(bool copy) {
            selectedRecord = (DocumentationGroupList)DgListView.SelectedItem;
            dataViewSupport.SelectedRecordId = selectedRecord.Id;
            SetRecord(true, copy);
        }
        ...
        private void DgListView_SelectionChanged(object sender, SelectionChangedEventArgs e) {
            ...
            { selectedRecord = (DocumentationGroupList)DgListView.SelectedItem; }
            else { selectedRecord = new DocumentationGroupList(); }
            dataViewSupport.SelectedRecordId = selectedRecord.Id;
            SetRecord(false);
        }
        ...
        private void BtnCancel_Click(object sender, RoutedEventArgs e) {
            selectedRecord = (DgListView.SelectedItems.Count > 0) ? (DocumentationGroupList)DgListView.SelectedItem : new DocumentationGroupList();
            SetRecord(false);
        }
