    ...
    public partial class BusinessCreditNoteListPage : UserControl {
        ...
        public async Task<bool> LoadDataList() {
            ...
            try {
                ...
                CreditNoteList = await CommApi.GetApiRequest<List<BusinessCreditNoteList>>(ApiUrls.BusinessCreditNoteList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token);
        ...
        public async void DeleteRecord() {
            ...
            if (result == MessageDialogResult.Affirmative) {
                DBResultMessage dBResult = await CommApi.DeleteApiRequest(ApiUrls.BusinessNotesList, selectedRecord.Id.ToString(), App.UserData.Authentification.Token);
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e) {
            try {
                ...
                if (selectedRecord.Id == 0) {
                    dBResult = await CommApi.PutApiRequest(ApiUrls.BusinessCreditNoteList, httpContent, null, App.UserData.Authentification.Token);
                }
                else { dBResult = await CommApi.PostApiRequest(ApiUrls.BusinessCreditNoteList, httpContent, null, App.UserData.Authentification.Token); }
                ...
                if (dBResult.RecordCount > 0) {
                    ...
                    dBResult = await CommApi.DeleteApiRequest(ApiUrls.BusinessCreditNoteSupportList, dBResult.Status, App.UserData.Authentification.Token);
                    ...
                    dBResult = await CommApi.PutApiRequest(ApiUrls.BusinessCreditNoteSupportList, httpContent, null, App.UserData.Authentification.Token);
        ...
        private async void SetRecord(bool? showForm = null, bool copy = false) {
            ...
            if (showForm != null && showForm == true) {
                ...
                else { DocumentItemList = await CommApi.GetApiRequest<List<DocumentItemList>>(ApiUrls.BusinessCreditNoteSupportList, originalDocumentNumber, App.UserData.Authentification.Token); }
        ...
        private async void ImportInvoice() {
            try {
                ...
                CreditNoteList = await CommApi.GetApiRequest<List<BusinessCreditNoteList>>(ApiUrls.BusinessCreditNoteList, null, App.UserData.Authentification.Token);
                CreditNoteList.ForEach(record => {
