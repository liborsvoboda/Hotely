    ...
    public partial class OftenQuestionListPage : UserControl {
        ...
        public async void DeleteRecord() {
            ...
            if (result == MessageDialogResult.Affirmative) {
                DBResultMessage dBResult = await ApiCommunication.DeleteApiRequest(ApiUrls.OftenQuestionList, selectedRecord.Id.ToString(), App.UserData.Authentification.Token);
