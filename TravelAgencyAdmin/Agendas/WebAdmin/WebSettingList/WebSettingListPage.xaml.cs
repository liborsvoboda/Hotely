...
namespace UbytkacAdmin.Pages {
    ...
    public partial class WebSettingListPage : UserControl {
        ...
        public async Task<bool> LoadDataList() {
            ...
            try {
                WebSettingList = await ApiCommunication.GetApiRequest<List<WebSettingList>>(ApiUrls.WebSettingList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token);
        ...
        public async void DeleteRecord() {
            ...
            if (result == MessageDialogResult.Affirmative) {
                DBResultMessage dBResult = await ApiCommunication.DeleteApiRequest(ApiUrls.WebSettingList, selectedRecord.Id.ToString(), App.UserData.Authentification.Token);
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e) {
            try {
                ...
                if (selectedRecord.Id == 0) {
                    dBResult = await ApiCommunication.PutApiRequest(ApiUrls.WebSettingList, httpContent, null, App.UserData.Authentification.Token);
                } else { dBResult = await ApiCommunication.PostApiRequest(ApiUrls.WebSettingList, httpContent, null, App.UserData.Authentification.Token); }
