...
namespace TravelAgencyAdmin.Pages
{
    public partial class AddressListPage : UserControl
    {
        ...
        public async Task<bool> LoadDataList()
        {
            ...
            try
            {
                DgListView.ItemsSource = await ApiCommunication.GetApiRequest<List<AddressList>>(ApiUrls.TravelAgencyAdminAddressList, (dataViewSupport.AdvancedFilter == null) ? null: "Filter/" + dataViewSupport.AdvancedFilter.Replace("[!]","").Replace("{!}",""), App.UserData.Authentification.Token);
            } catch { }
        ...
        public async void DeleteRecord()
        {
            ...
            {
                DBResultMessage dBResult = await ApiCommunication.DeleteApiRequest(ApiUrls.TravelAgencyAdminAddressList, selectedRecord.Id.ToString(), App.UserData.Authentification.Token);
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                { dBResult = await ApiCommunication.PutApiRequest(ApiUrls.TravelAgencyAdminAddressList, httpContent, null, App.UserData.Authentification.Token);
                } else { dBResult = await ApiCommunication.PostApiRequest(ApiUrls.TravelAgencyAdminAddressList, httpContent, null, App.UserData.Authentification.Token); }
