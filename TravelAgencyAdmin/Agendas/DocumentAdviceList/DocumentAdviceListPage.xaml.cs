...
namespace TravelAgencyAdmin.Pages
{
    public partial class DocumentAdviceListPage : UserControl
    {
        ...
        public async Task<bool> LoadDataList()
        {
            ...
            try
            {
                cb_branch.ItemsSource = BranchList = await ApiCommunication.GetApiRequest<List<BranchList>>(ApiUrls.TravelAgencyAdminBranchList, null, App.UserData.Authentification.Token);
                documentAdviceList = await ApiCommunication.GetApiRequest<List<DocumentAdviceList>>(ApiUrls.TravelAgencyAdminDocumentAdviceList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token);
        ...
        public async void DeleteRecord()
        {
            ...
            {
                DBResultMessage dBResult = await ApiCommunication.DeleteApiRequest(ApiUrls.TravelAgencyAdminDocumentAdviceList, selectedRecord.Id.ToString(), App.UserData.Authentification.Token);
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                { dBResult = await ApiCommunication.PutApiRequest(ApiUrls.TravelAgencyAdminDocumentAdviceList, httpContent, null, App.UserData.Authentification.Token);
                } else { dBResult = await ApiCommunication.PostApiRequest(ApiUrls.TravelAgencyAdminDocumentAdviceList, httpContent, null, App.UserData.Authentification.Token); }
