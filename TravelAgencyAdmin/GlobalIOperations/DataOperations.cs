...
namespace UbytkacAdmin.GlobalOperations {
    ...
    internal class DataOperations : MainWindow {
        ...
        /// <summary>
        /// !!! SYSTEM RULE: ClassList with joining fields names must be null able before API
        ...
        /// <summary>
        /// Global Method for Using API Uris as Unique Generic List for All API Call - logic is All
        /// standardized not only DataPages as automated Logic
        /// </summary>
