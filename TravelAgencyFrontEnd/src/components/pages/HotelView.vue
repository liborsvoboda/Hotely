    ...
    methods:{
        async SetFavorite() {
            if (this.loggedIn) {
                ...
                ShowNotify('success', this.isFavorite ? this.$i18n.t("messages.addedToFavorite") : this.$i18n.t("messages.removedFromFavorite"));
            } else { 
                ShowNotify('info', this.$i18n.t("messages.forSaveToFavoriteYouMustBeLogged"));
            }
        },
    },
    created() {
