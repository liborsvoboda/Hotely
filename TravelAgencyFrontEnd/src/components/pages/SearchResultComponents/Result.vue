            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-5">
                    <div class="row">
                        ...
                        <div class=" col-md-6 pt-0 mt-0 text-start">
                            <h5 class="c-pointer" @click="createRoomListBox()" data-role="hint" data-cls-hint="bg-cyan fg-white drop-shadow" :data-hint-text="$t('labels.clickForAccommodationSpace')">
