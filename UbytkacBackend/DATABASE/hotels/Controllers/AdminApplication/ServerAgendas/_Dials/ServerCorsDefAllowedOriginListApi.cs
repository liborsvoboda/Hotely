namespace UbytkacBackend.Controllers {
    ...
    public class ServerCorsDefAllowedOriginListApi : ControllerBase {
        ...
        [HttpGet("/ServerCorsDefAllowedOriginList")]
        ...
        [HttpGet("/ServerCorsDefAllowedOriginList/Filter/{filter}")]
        ...
        [HttpGet("/ServerCorsDefAllowedOriginList/{id}")]
        ...
        [HttpPut("/ServerCorsDefAllowedOriginList")]
        ...
        [HttpPost("/ServerCorsDefAllowedOriginList")]
        [Consumes("application/json")]
        ...
        [HttpDelete("/ServerCorsDefAllowedOriginList/{id}")]
        [Consumes("application/json")]
