namespace UbytkacBackend.Controllers {
    ...
    public class ServerBrowsablePathListApi : ControllerBase {
        ...
        [HttpGet("/ServerBrowsablePathList")]
        ...
        [HttpGet("/ServerBrowsablePathList/Filter/{filter}")]
        ...
        [HttpGet("/ServerBrowsablePathList/{id}")]
        ...
        [HttpPut("/ServerBrowsablePathList")]
        ...
        [HttpPost("/ServerBrowsablePathList")]
        [Consumes("application/json")]
        ...
        [HttpDelete("/ServerBrowsablePathList/{id}")]
        [Consumes("application/json")]
