namespace UbytkacBackend.Controllers {
    ...
    public class UbytkacBackendDocSrvDocTemplateListApi : ControllerBase {
        ...
        [HttpGet("/DocSrvDocTemplateList/Filter/{filter}")]
        ...
        [HttpGet("/DocSrvDocTemplateList/{id}")]
        ...
        [HttpPost("/DocSrvDocTemplateList")]
        [Consumes("application/json")]
        ...
        [HttpDelete("/DocSrvDocTemplateList/{id}")]
        [Consumes("application/json")]
