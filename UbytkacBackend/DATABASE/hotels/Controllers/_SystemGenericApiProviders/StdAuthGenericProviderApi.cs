...
namespace UbytkacBackend.ServerCoreDBSettings {
    ...
    [ApiController]
    public abstract class StdAuthGenericProviderApi<DbEntity, Tentity, TKey> : ControllerBase where DbEntity : hotelsContext where Tentity : class where TKey : notnull {
