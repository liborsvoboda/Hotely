...
namespace UbytkacBackend.ServerCoreDBSettings {
    ...
    [ApiController]
    public abstract class StdFreeGenericProviderApi<DbEntity, Tentity, TKey> : ControllerBase where DbEntity : hotelsContext where Tentity : class where TKey : notnull {
