namespace UbytkacBackend.Controllers {
    ...
    [Authorize]
    [ApiController]
    [Route("UbytkacBackendSystemReportList")]
    public class UbytkacBackendSystemReportListApi : ControllerBase {

        [HttpGet("/UbytkacBackendSystemReportList")]
        ...
        [HttpGet("/UbytkacBackendSystemReportList/Filter/{filter}")]
        ...
        [HttpGet("/UbytkacBackendSystemReportList/{id}/{name}")]
        ...
        [HttpPut("/UbytkacBackendSystemReportList")]
        ...
        [HttpPost("/UbytkacBackendSystemReportList")]
        [Consumes("application/json")]
        ...
        [HttpDelete("/UbytkacBackendSystemReportList/{id}")]
        [Consumes("application/json")]
