namespace UbytkacBackend.Controllers {
    ...
    [Authorize]
    [ApiController]
    [Route("UbytkacBackendSystemReportQueueList")]
    public class UbytkacBackendSystemReportQueueListApi : ControllerBase {

        [HttpGet("/UbytkacBackendSystemReportQueueList")]
        ...
        [HttpGet("/UbytkacBackendSystemReportQueueList/Filter/{filter}")]
        ...
        [HttpGet("/UbytkacBackendSystemReportQueueList/{id}")]
        ...
        [HttpPut("/UbytkacBackendSystemReportQueueList")]
        ...
        [HttpPost("/UbytkacBackendSystemReportQueueList/WriteFilter")]
        [Consumes("application/json")]
        ...
        [HttpPost("/UbytkacBackendSystemReportQueueList")]
        [Consumes("application/json")]
        ...
        [HttpDelete("/UbytkacBackendSystemReportQueueList/{id}")]
        [Consumes("application/json")]
