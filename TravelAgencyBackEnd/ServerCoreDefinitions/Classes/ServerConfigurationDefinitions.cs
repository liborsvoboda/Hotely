namespace UbytkacBackend.ServerCoreStructure {
    ...
    public partial class ServerConfigSettings {
        ...
        /// </summary>
        public static string DatabaseConnectionString { get; set; } = "Server=127.0.0.1;Database=UbytkacBackend;Trusted_Connection=True;TrustServerCertificate=True";
        ...
        /// <summary>
        /// Activate Redirection on 404 Pange Nt Found
        /// </summary>
        ...
        /// <summary>
        /// Redirection Path For Redirecting on Page not Found
        /// When redirection is Enabled
        /// </summary>
        public static string RedirectPath { get; set; } = "/SystemPage";
